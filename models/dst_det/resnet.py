...
from mmdet.models.builder import BACKBONES, HEADS
import numpy as np
import torch
...
class ModifiedResNet(BaseModule):
    ...
    def __init__(self, layers, output_dim, heads, input_resolution=224, width=64, init_cfg=None):
